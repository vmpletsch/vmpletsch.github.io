...
<div style="background: #ffffff; padding: 40px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.08); border: 1px solid #f0f0f0;">
  ...
  <div class="mb-4">
    ...
    <textarea class="form-control" id="customMessage" rows="8" placeholder="Write your message here..." style="font-size: 1.05rem;" oninput="document.getElementById('sendEmailBtn').href = 'mailto:vmpletsch@gmail.com?body=' + encodeURIComponent(this.value);"></textarea>
  </div>
  <div class="text-center" style="margin-top: 30px;">
    <a id="sendEmailBtn" href="mailto:vmpletsch@gmail.com" class="btn btn-primary" style="background-color: #fa70ff; border-color: #fa70ff; width: 100%; font-weight: bold; font-size: 1.1rem; border-radius: 8px; padding: 12px;">
      Send Message
    </a>
  </div>
</div>
