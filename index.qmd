...
<style>
  ...
  .alt-window-task.is-about-task { align-self: stretch; box-sizing: border-box; flex: 0 0 120px; font-size: clamp(10px, .9vw, 13px); justify-content: center; max-width: 120px; min-width: 120px; padding: 0 6px; }
...
<script>
  (function () {
    ...
    function openPortfolioWindow(link) {
      ...
      if (title === 'About Me') task.classList.add('is-about-task');
