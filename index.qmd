...
<style>
  ...
  .alt-window-task.is-about-task, .alt-window-task.is-about-task.is-active, .alt-window-task.is-projects-task, .alt-window-task.is-projects-task.is-active, .alt-window-task.is-resume-task, .alt-window-task.is-resume-task.is-active { align-self: stretch; background: transparent; border: 0; box-sizing: border-box; flex: 0 0 120px; max-width: 120px; min-width: 120px; padding: 0; }
  .alt-window-task.is-about-task img, .alt-window-task.is-projects-task img, .alt-window-task.is-resume-task img { display: block; height: 38px; image-rendering: pixelated; width: 120px; }
...
<script>
  (function () {
    ...
    function openPortfolioWindow(link) {
      ...
      const taskArtwork = title === 'About Me'
        ? { closed: 'images/ux-dashboard/aboutme_closed.png', cssClass: 'is-about-task', open: 'images/ux-dashboard/aboutme_open.png' }
        : title === 'Projects'
          ? { closed: 'images/ux-dashboard/projects_closed.png', cssClass: 'is-projects-task', open: 'images/ux-dashboard/projects_open.png' }
          : title === 'Resume & Experience'
            ? { closed: 'images/ux-dashboard/resume_closed.png', cssClass: 'is-resume-task', open: 'images/ux-dashboard/resume_open.png' }
            : null;
      if (taskArtwork) {
        task.classList.add(taskArtwork.cssClass);
