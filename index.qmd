...
<style>
  ...
  .alt-desktop-icons { align-content: start; display: grid; gap: 20px 28px; grid-template-columns: repeat(2, clamp(68px, 7.8vw, 100px)); grid-template-rows: repeat(4, 86px); inset: auto; left: 3vw; position: absolute; top: 4vh; z-index: 1; }
