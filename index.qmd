...
<style>
  ...
  .alt-window-task.is-about-task, .alt-window-task.is-about-task.is-active, .alt-window-task.is-projects-task, .alt-window-task.is-projects-task.is-active { align-self: stretch; background: transparent; border: 0; box-sizing: border-box; flex: 0 0 120px; max-width: 120px; min-width: 120px; padding: 0; }
  .alt-window-task.is-about-task img, .alt-window-task.is-projects-task img { display: block; height: 38px; image-rendering: pixelated; width: 120px; }
