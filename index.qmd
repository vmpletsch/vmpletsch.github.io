---
title: "Veronica Pletsch"
description: "An interactive retro desktop portfolio for Veronica Pletsch."
toc: false
page-layout: full
format:
  html:
...
<style>
  ...
  .alt-desktop-icons { align-content: start; display: grid; gap: 20px 28px; grid-template-columns: repeat(2, clamp(68px, 7.8vw, 100px)); grid-template-rows: repeat(4, 86px); inset: auto; bottom: 48px; left: 3vw; position: absolute; top: auto; z-index: 1; }
  .alt-icon { align-items: center; color: #fff4ff; display: flex; flex-direction: column; font-family: monospace; font-size: clamp(8px, .78vw, 13px); font-weight: 900; gap: 4px; left: 3vw; line-height: 1.08; position: absolute; text-align: center; text-decoration: none !important; text-shadow: 1px 1px 0 #14043f, 0 0 6px rgba(100,246,255,.72); width: clamp(68px, 7.8vw, 100px); }
  .alt-icon img { image-rendering: pixelated; max-height: 52px; max-width: 60px; object-fit: contain; }
  ...
  .alt-contact img { max-width: 70px; }
  ...
  .alt-portfolio-window.is-about-window .alt-window-titlebar { font-size: clamp(15px, 1.25vw, 20px); min-height: 36px; }
  .alt-window-titlebar { align-items: center; background: linear-gradient(90deg, #a84b85, #6d3f72); color: #fff; cursor: move; display: flex; font-family: monospace; font-size: clamp(9px, .9vw, 13px); font-weight: 900; gap: 7px; justify-content: space-between; min-height: 28px; padding: 3px 4px 3px 8px; touch-action: none; user-select: none; }
  .alt-window-titlebar.is-dragging { filter: brightness(1.08); }
  ...
  .alt-taskbar { align-items: center; background: #d6cbd9 url("images/ux-dashboard/footer.png") left bottom / auto 38px repeat-x; bottom: 0; box-sizing: border-box; display: flex; height: 38px; left: 0; overflow: hidden; padding: 0; position: absolute; right: 0; z-index: 4; }
  .alt-start { appearance: none; background: transparent; border: 0; cursor: none; flex: 0 0 120px; height: 38px; margin: 0; padding: 0; position: relative; width: 120px; }
  .alt-start img, .alt-task-label img { display: block; height: 38px; image-rendering: pixelated; width: auto; }
  .alt-start img { transition: filter 70ms linear, transform 70ms steps(1, end); }
  .alt-start:active img, .alt-start.is-pressed img { filter: brightness(.79); transform: translate(2px, 2px); }
  .alt-task-label { flex: 0 0 240px; height: 38px; white-space: nowrap; }
  .alt-window-tasks { align-items: center; align-self: stretch; display: flex; flex: 1 1 auto; gap: 5px; min-width: 0; overflow-x: auto; padding-left: 6px; }
  ...
  .alt-window-task[data-open-artwork], .alt-window-task[data-open-artwork].is-active { align-self: stretch; background: transparent; border: 0; box-sizing: border-box; flex: 0 0 120px; max-width: 120px; min-width: 120px; padding: 0; }
  .alt-window-task[data-open-artwork] img { display: block; height: 38px; image-rendering: pixelated; width: 120px; }
  .alt-window-task.is-active { background: #e5c6df; border-style: inset; }
  .alt-exit-retro { align-items: center; background: #c9c5bf; border: 2px outset #fff; color: #2d2330; cursor: none; display: inline-flex; flex: 0 0 auto; font-family: monospace; font-size: clamp(8px, .76vw, 11px); font-weight: 900; gap: 4px; height: 30px; justify-content: center; margin: 3px 6px 3px 8px; padding: 0 9px; text-decoration: none !important; text-shadow: none; white-space: nowrap; }
  .alt-exit-retro:hover, .alt-exit-retro:focus-visible { background: #ead0e8; color: #2d2330; }
  .alt-exit-retro:active { border-style: inset; transform: translate(1px, 1px); }
  .alt-exit-retro:focus-visible { outline: 2px solid #fff; outline-offset: -4px; }
  .alt-desktop-boot-loader { display: grid; inset: 0; place-items: center; pointer-events: none; position: absolute; z-index: 3; }
  .alt-hourglass { display: block; height: 32px; image-rendering: pixelated; width: 32px; }
  .alt-message, .alt-welcome, .alt-loading { align-items: center; display: grid; justify-items: center; z-index: 3; }
  .alt-message-art { height: min(52vh, 54vw, 520px); position: relative; width: min(52vh, 54vw, 520px); }
  .alt-message img { display: block; height: 100%; object-fit: contain; width: 100%; }
  .alt-welcome img { height: min(68vh, 700px); object-fit: contain; width: min(72vw, 700px); }
  .alt-message .alt-hotspot { background: transparent; border: 0; height: 15%; left: 36%; position: absolute; top: 63%; width: 28%; }
  ...
  #alt-pixel-cursor { display: none; image-rendering: pixelated; left: 0; pointer-events: none; position: absolute; top: 0; transform: translate(-3%, -3%); width: clamp(15px, 1.55vw, 24px); z-index: 10; }
  ...
  @media (max-width: 700px) { .alt-desktop-icons { gap: 16px 20px; grid-template-columns: repeat(2, 72px); grid-template-rows: repeat(4, 78px); left: 2vw; }.alt-icon { font-size: 7px; width: 72px; }.alt-icon img { max-height: 46px; max-width: 54px; }.alt-icon { left: 2vw; }.alt-portfolio-window { min-height: 250px; min-width: 300px; resize: none; }.alt-window-layer { bottom: 40px; }.alt-window-titlebar { min-height: 25px; }.alt-portfolio-window.is-about-window .alt-window-titlebar { font-size: 14px; min-height: 31px; }.alt-window-control { height: 18px; width: 20px; }.alt-post-screen { font-size: 12px; padding: 14px; }.alt-diagnostic-screen { font-size: 10px; padding: 12px; }.alt-diagnostic-panel { border-width: 4px; padding: 8px 10px 10px; width: 100%; }.alt-diagnostic-section + .alt-diagnostic-section { margin-left: -10px; margin-right: -10px; padding-left: 10px; padding-right: 10px; }.alt-diagnostic-row { grid-template-columns: 44% 1fr; }.alt-diagnostic-list { margin-top: 34px; }.alt-diagnostic-device { grid-template-columns: 4ch 6ch 7ch 1fr; } }
</style>
...
<section class="alt-home-desktop" aria-label="Experimental desktop portfolio homepage">
  ...
  <div class="alt-desktop-icons" hidden>
    ...
    <a class="alt-icon alt-sabrina" href="about-me.html" data-window-title="About Me"><img src="images/ux-dashboard/sabrina.png" alt=""><span>Sabrina</span></a>
  </div>

  <div class="alt-window-layer" hidden aria-live="polite"></div>

  <div class="alt-layer alt-message">
    <div class="alt-message-art">
  ...
  <div class="alt-desktop-boot-loader" hidden role="status" aria-label="Loading desktop"><img class="alt-hourglass" src="images/ux-dashboard/hourglass.gif" alt="" aria-hidden="true"></div>
  <div class="alt-taskbar" hidden><button class="alt-start" type="button" aria-label="Home"><img src="images/ux-dashboard/homebutton.png" alt=""></button><span class="alt-task-label"><img src="images/ux-dashboard/veronicafooter.png" alt="Veronica Pletsch"></span><div class="alt-window-tasks" aria-label="Open portfolio windows"></div><a class="alt-exit-retro" href="classic-home.html" aria-label="Exit out of retro desktop"><span aria-hidden="true">→</span><span>Exit out of retro desktop</span></a></div>
  <img id="alt-pixel-cursor" src="images/ux-dashboard/pink_arrowcursor.png" data-arrow="images/ux-dashboard/pink_arrowcursor.png" data-hand="images/ux-dashboard/hand_cursor.png" alt="" aria-hidden="true">
</section>
...
<script>
  (function () {
    ...
    function minimizeWindow(url) {
      ...
      updateWindowTaskArtwork(entry, false);
    ...
    function restoreWindow(url) {
      ...
      updateWindowTaskArtwork(entry, true);
      focusWindow(entry.window);
      status.textContent = entry.title + ' window restored.';
    }

    function updateWindowTaskArtwork(entry, isOpen) {
      if (!entry || !entry.task.dataset.openArtwork || !entry.task.dataset.closedArtwork) return;
      const artwork = entry.task.querySelector('img');
      if (artwork) artwork.src = isOpen ? entry.task.dataset.openArtwork : entry.task.dataset.closedArtwork;
    }
    ...
    function makeWindowDraggable(portfolioWindow, titlebar) {
      let drag = null;
      ...
      function finishDrag(event) {
        ...
        if (titlebar.hasPointerCapture && titlebar.hasPointerCapture(pointerId)) titlebar.releasePointerCapture(pointerId);
      }

      titlebar.addEventListener('pointerdown', function (event) {
        if (event.isPrimary === false || (event.pointerType === 'mouse' && event.button !== 0)) return;
        if (event.target.closest('.alt-window-controls') || portfolioWindow.classList.contains('is-maximized')) return;
        const layerBounds = windowLayer.getBoundingClientRect();
        const windowBounds = portfolioWindow.getBoundingClientRect();
        drag = {
          left: windowBounds.left - layerBounds.left,
          pointerId: event.pointerId,
          startX: event.clientX,
          startY: event.clientY,
          top: windowBounds.top - layerBounds.top
        };
        titlebar.classList.add('is-dragging');
        try { titlebar.setPointerCapture(event.pointerId); } catch (error) { /* Synthetic and assistive pointer events may not support capture. */ }
        focusWindow(portfolioWindow);
      ...
      titlebar.addEventListener('pointermove', function (event) {
        ...
        const layerBounds = windowLayer.getBoundingClientRect();
        const windowBounds = portfolioWindow.getBoundingClientRect();
        const maxLeft = Math.max(0, layerBounds.width - Math.min(windowBounds.width, layerBounds.width));
        const maxTop = Math.max(0, layerBounds.height - Math.min(windowBounds.height, layerBounds.height));
        const nextLeft = Math.min(maxLeft, Math.max(0, drag.left + event.clientX - drag.startX));
        const nextTop = Math.min(maxTop, Math.max(0, drag.top + event.clientY - drag.startY));
        portfolioWindow.style.left = nextLeft + 'px';
        portfolioWindow.style.top = nextTop + 'px';
        event.preventDefault();
      });

      titlebar.addEventListener('pointerup', finishDrag);
      titlebar.addEventListener('pointercancel', finishDrag);
      titlebar.addEventListener('lostpointercapture', finishDrag);
    }
    ...
    function openPortfolioWindow(link) {
      ...
      if (title === 'About Me') portfolioWindow.classList.add('is-about-window');
      ...
      const taskArtworkByTitle = {
        'About Me': { closed: 'images/ux-dashboard/aboutme_closed.png', open: 'images/ux-dashboard/aboutme_open.png' },
        'Contact': { closed: 'images/ux-dashboard/contactme_closed.png', open: 'images/ux-dashboard/contactme_open.png' },
        'Presentations': { closed: 'images/ux-dashboard/presentation_closed.png', open: 'images/ux-dashboard/presentation_open.png' },
        'Projects': { closed: 'images/ux-dashboard/projects_closed.png', open: 'images/ux-dashboard/projects_open.png' },
        'Resume & Experience': { closed: 'images/ux-dashboard/resume_closed.png', open: 'images/ux-dashboard/resume_open.png' },
        'Writing Samples': { closed: 'images/ux-dashboard/writing_closed.png', open: 'images/ux-dashboard/writing_open.png' }
      };
      const taskArtwork = taskArtworkByTitle[title];
      if (taskArtwork) {
        task.dataset.openArtwork = taskArtwork.open;
        task.dataset.closedArtwork = taskArtwork.closed;
        task.textContent = '';
        const taskArtworkImage = document.createElement('img');
        taskArtworkImage.src = task.dataset.openArtwork;
        taskArtworkImage.alt = '';
        task.append(taskArtworkImage);
      }
      ...
      makeWindowDraggable(portfolioWindow, titlebar);
    ...
    desktop.querySelector('.alt-start').addEventListener('click', function (event) {
      ...
      if (active) {
        const activeTitle = openWindows.get(active.dataset.windowUrl).title;
        minimizeWindow(active.dataset.windowUrl);
        status.textContent = activeTitle + ' minimized. Dashboard restored.';
      } else {
        status.textContent = 'Dashboard restored.';
      }
      window.setTimeout(function () { homeButton.classList.remove('is-pressed'); }, 240);
    });
